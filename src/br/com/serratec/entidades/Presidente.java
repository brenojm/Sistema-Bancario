...
public class Presidente extends Funcionario {
	...
	// Variavel para soma das taxas cobradas pelo banco, para somar no capital total
	// do campo
	...
	public static double getCapitalTotalBanco() {
		return RepositorioContaCorrente.getCapitalCorrente() + RepositorioContaPoupanca.getCapitalPoupanca()
				+ getCapitalTaxa();
	}
