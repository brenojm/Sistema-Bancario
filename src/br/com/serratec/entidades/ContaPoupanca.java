...
public class ContaPoupanca extends Conta {
	...
	public void rendimentoPoupanca(double valorInserido, String dataInicialString, String dataFinalString)
		...
		try {
			...
			System.out.println("--===Simulação Rendimento da Poupança===--" + "\nRendimento: R$"
					+ String.format("%.2f", rendimentoTotal) + "\nData Inicial: "
					+ formatoDataBrasil.format(dataInseridaInicial) + "\nData Final: "
					+ formatoDataBrasil.format(dataInseridaFinal) + "\nMeses: " + mesesInseridos
