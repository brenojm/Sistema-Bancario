...
public interface metodosConta {
	...
	public void transferencia(double valorInserido, String cpf, char tipoConta) throws valorInvalidoException, ContaInvalidaException, CadastroNaoExisteException;
