...
public class SeguroVida {
	...
	public SeguroVida(String cpfSegurado, double valorSegurado, int qtdMeses, List<String> segurados)
			throws CpfInvalidoException, SaldoInsuficienteException, valorInvalidoException {
		if (qtdMeses <= 0 || valorSegurado <= 0) {
			throw new valorInvalidoException();
		}

		// falta o repositório da conta
		// if((valorSegurado * TaxasDaConta.taxaSeguroDeVida) >
		// (cpfSegurado).getSaldo()) {
